...
public typealias Common_BasicHttpGetAgent = NetworkinNameSpace.BasicHttpGetAgent // Handles simple GETs (`func getDataFrom:`, `func getJSONFrom:`) and images download with caching
